...
#we creat a window called root  using tkinter 
root = Tk()
root.geometry('300x300')
root.title('GHITA OUARZI-Mad Libs Generator')
...
##define buttons
Button(root, text= 'The Photographer', font ='arial 15', command= madlib1, bg = 'pink').place(x=60, y=120)
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'pink').place(x=70, y=180)
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'pink').place(x=80, y=240)
